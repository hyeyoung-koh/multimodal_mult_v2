...
if __name__ == "__main__":
    ...
    parser.add_argument('--bert_path', type=str, default='./korean_audiotext_transformer/KoBERT')
    #parser.add_argument('--bert_path', type=str,default='./KoBERT')
    #parser.add_argument('--model_path', type=str, default='D:/Users/hyeyoung/OneDrive - dongguk.edu/문서/카카오톡 받은 파일/epoch1-loss1.7936-f10.2047/MULT1.bin')
    parser.add_argument('--model_path', type=str, default='.korean_audiotext_transformer/model/MULT1.bin')
    #parser.add_argument('--model_path',type=str,default='./model/MULT1.bin')
